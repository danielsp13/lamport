...
int& LVM_Segment_Table::operator()(int segment, int virtual_dir){
...
const int LVM_Segment_Table::operator()(int segment, int virtual_dir) const {
    return this->get_phisical_addr(segment,virtual_dir);
}
