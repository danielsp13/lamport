...
\begin{document}
	...
	\newpage
        ...
        \include{secciones/02_descripcion}
        \include{secciones/03_planificacion}

        % Segunda parte : estado del arte
        \part{Estado del arte}
        \include{secciones/04_estado_del_arte}

        % Tercera parte : fundamentos teoricos
        \part{Fundamentos teóricos y matemáticos}
        \include{secciones/05_concurrencia}
        \include{secciones/06_ptla}
        \include{secciones/07_pl}
        ...
        %\include{secciones/02_descripcion}
        %\include{secciones/03_estado_del_arte}
        %\include{secciones/04_planificacion}
        \include{secciones/08_herramientas}
	\include{secciones/09_espec_lenguaje}
	\include{secciones/10_implementacion}
	\include{secciones/11_programas}

        % Quinta parte : Conclusiones
        \part{Conclusiones}
	\include{secciones/12_conclusiones}
