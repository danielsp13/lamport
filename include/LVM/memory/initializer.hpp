...
#include "LVM/memory/memory.hpp"                   ///< Memoria de LVM
#include "LVM/memory/segment_table.hpp"            ///< Tabla de segmentos de LVM
#include "LVM/memory/bounds.hpp"                   ///< Registro de limites de arrays

#include "LVM/SO/thread_manager.hpp"           ///< Gestor de hebras

#include "IR/tables/table.hpp"                 ///< Tablas IR
