...
#include "IR/tweaks/ir_thread_id_manager.hpp" ///< Manejador de id de hebras
...
class IR_Translator_Statement{
    private:
        ...
        /**
         * @brief Traduce una sentencia sleep a instrucciones IR
         * @param stmt : sentencia AST
         */
        void translate_statement_sleep_to_ir_instructions(struct statement * stmt, bool from_subprogram = false);
