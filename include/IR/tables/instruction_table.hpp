...
class IR_Instruction_Table{
    ...
    public:
        ...
        /**
         * @brief Crea un operando de tipo id thread
         * @param id_thread : id de thread
         * @return operando
         */
        IR_operand emit_operand_id_thread(int id_thread);

        /**
         * @brief Crea un operando de tipo salto directo
         * @param jmp_addr : direccion de salto
         */
        IR_operand emit_operand_direct_jmp(int jmp_addr);
        ...
        /**
         * @brief Reemplaza la instruccion dada en la posicion dada
         * @param instr : instruccion
         * @param position : posicion
         */
        void replace_instruction_in_position(IR_instruction instr, int position);
