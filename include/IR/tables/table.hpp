...
#include "IR/tables/table_entry.hpp"          ///< Entrada de tabla IR
#include "IR/elements/literal.hpp"              ///< Literal IR
#include "IR/elements/variable.hpp"             ///< Variable IR
#include "IR/elements/label.hpp"                ///< Etiqueta IR
